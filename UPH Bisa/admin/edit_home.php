    ...
    <?php
          ...
          <div class='latest-products'>
              ...
              <div class='row'>
                ...
                <div class='col-md-4'>
                  <div class='product-item'>
                      <a href='edit.php?id=".$row['id_info']."'><img src='../upload/".$row['images']."' alt=''></a>
                      <div class='down-content'>
                        <a href='edit.php?id=".$row['id_info']."'><h4> ".$row['judul']."</h4></a>
            ...
            echo "
              ...
              <div class='row'>
                  <div class='col-md-6'>
                  <a class='btn btn-primary' href='home-admin.php'>Exit</a>
                  </div>
              </div>
            </div>
          </div>";
