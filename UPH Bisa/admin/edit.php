        ...
        <div class="row">
          <div class="col-md-9 col-sm-8">
            ...
            <p class="lead">
                    ...
                    <br><h5>Harga </h5><br>
                    <span>Gold: </span><br>
                    <input class='form-control col-md-5' type='text' name='harga_gold' value="<?php echo $info['harga_gold'];?>"><br><br>
                    <sppan>Silver: </sppan><br>
                    <input class='form-control col-md-5' type='text' name='harga_silver' value="<?php echo $info['harga_silver'];?>"><br><br>
                    <sppan>Bronze: </sppan><br>
                    <input class='form-control col-md-5' type='text' name='harga_bronze' value="<?php echo $info['harga_bronze'];?>"><br><br>
                    
                    <hr><h3>PartnerShip </h3><br>
                    Gold Partnership
                    <textarea id="ship_gold" class='form-control col-md-5' type='text' name='ship_gold'> <?php echo $info['ship_gold'];?> </textarea><br><br>
                    <script>
                        ClassicEditor
                    ...
                    Silver Partnership
                    <textarea id="ship_silver" class='form-control col-md-5' type='text' name='ship_silver'> <?php echo $info['ship_silver'];?> </textarea><br><br>
                    <script>
                        ClassicEditor
                    ...
                    Bronze Partnership
                    <textarea id="ship_bronze" class='form-control col-md-5' type='text' name='ship_bronze'> <?php echo $info['ship_bronze'];?> </textarea><br><br>
                    <script>
                        ClassicEditor
          ...
          <div class="col-md-3 col-sm-4">
            <div class="contact-form">
              <div class="form-group">
                ...
                <input type="submit" name="action" value="Save" class="btn btn-primary col-md-12">
              </div>
            </div>
            ...
            <br>
              ...
              <a class='btn btn-primary col-md-12' href="editFotoInfo.php?id=<?php echo $info['id_info'];?>">Edit Foto</a>
