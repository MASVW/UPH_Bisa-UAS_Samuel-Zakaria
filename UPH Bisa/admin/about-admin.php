            ...
            <div class="right-image">
              ...
              <div class="contact-form">
                <div class="form-group">
                  <a href="about-edit.php?id=1" class="filled-button btn-block col-md-6">Edit This Information</a>
                </div>
            </div> 
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="left-content">
              ...
              <div class="contact-form">
                <div class="form-group">
                  <a href="about-edit.php?id=2 " class="filled-button btn-block col-md-3">Edit This Information</a>
                </div>
              </div> 
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="contact-form">
                <div class="form-group">
                  <a href="about-edit.php?id=3 " class="filled-button btn-block col-md-6">Edit This Information</a>
                </div>
            </div> 
          </div>
          <div class="col-md-4">
