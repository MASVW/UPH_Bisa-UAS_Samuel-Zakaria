        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4><?php echo $psn['Subject'];?></h4>
              
              <h2><?php echo $psn['uname'];?></h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><?php echo $psn['uname'];?></h2>
              <p><?php echo $psn['Subject'];?></p>
              <p><?php echo $psn['email'];?></p>
            </div>
            Isi Pesan :
            <p><?php echo $psn['msg'];?></p>
            <form action='../function/pesan/prosespesan.php' method='POST'>
              <input type="hidden" name="idp" value="<?php echo $psn['idp'];?>">
              <br>
              <input type="submit" name="action" value="Hapus Pesan" class="btn btn-primary col-md-3">
            </form>
          </div>
        </div>
      </div>
