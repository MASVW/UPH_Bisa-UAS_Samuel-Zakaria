      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 col-sm-8">
              ...
              Bronze :<span> Rp. <?php echo $info['harga_bronze']?></span>
          ...
          <div class="col-md-3 col-sm-4">
            <div class="contact-form">
              <div class="form-group">
                <a href="edit.php?id=<?php echo $info['id_info']?>" class="filled-button btn-block">Edit This Event</a>
              </div>
            </div>
            ...
            <br>
              <div class="form-group">
                <a href="delete.php?id=<?php echo $info['id_info'];?>" class="filled-button btn-block">Delete This Event</a>
              </div>
          </div>
        </div>
      </div>
