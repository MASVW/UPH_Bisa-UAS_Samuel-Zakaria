...
@media (max-width: 600px) {
  ...
  <body>
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="forum-admin.php" class="active">
          <i class='bx bx-coin-stack' ></i>
  ...
  <div class="send-message">
    <div class="container">
      <div class="row">
          ...
          <div class="contact-form">
            <form id="contact" action="../function/login/proseslogin.php" method="POST">
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <fieldset>
                    <input name="no_telp" type="text" class="form-control" id="password" placeholder="No Telepon">
                  </fieldset>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <fieldset>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <fieldset>
                    <input name="pass2" type="password" class="form-control" id="password" placeholder="Konfirmasi Password">
                  </fieldset>
                </div>
                  <div class="col-lg-12">
                  <fieldset>
                      <input type="hidden" name="akses" value="admin">
                      <input type="submit" name="action" value="Tambah Admin" class="filled-button">
                  </fieldset>
        ...
        <div class="col-md-4">
          <img src="../assets/images/signup.jpg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  </div>
