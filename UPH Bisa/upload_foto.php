          ...
          <div class="bg-white shadow rounded-lg d-block d-sm-flex">
            ...
            <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                <h3 class="mb-4">Edit Foto Profile</h3>
                <form action='function/login/proseslogin.php' method='POST' enctype='multipart/form-data'>           
                <div class="row">
                    <div class="col-md-6">
                  ...
                  <div>
                    ...
                    <input type="hidden" name="akses" value="<?php echo $row['akses'];?>">
                    <input type="hidden" name="email" value="<?php echo $row['email'];?>">
                    <input type="hidden" name="pass" value="<?php echo $row['pass'];?>">
                    <input type="hidden" name="bio" value="<?php echo $row['bio'];?>">
                    <input type="hidden" name="no_telp" value="<?php echo $row['no_telp'];?>">
                  </div>
                  <div>
                    <br>
                    <br>
                    <input class='btn btn-primary col-md-5' type='file' name='image' accept='.jpg, .png, .jpeg' value=''>
                  </div>
                  <div>
                    <br>
